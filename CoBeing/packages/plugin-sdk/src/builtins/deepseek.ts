 ...
 */
import { OpenAICompatProvider, PROVIDER_CATALOGS, getProvider } from "@cobeing/providers";
...
const plugin: CoBeingPlugin = {
  ...
  register(api: CoBeingPluginApi): void {
    // Skip if already registered natively by buildProviders() with richer config (decrypt, models.json)
