...
你可以在群组聊天中实时观看 Agent 们的协作过程。`,
  },
  {
    title: "设置与配置",
    subtitle: "按需连接 LLM",
    content: `点击顶部导航栏的 ⚙ 进入设置页（智能体/群组/仪表盘/扩展等入口收在 ⋯ 菜单里；如需要完整导航可在 设置 → 常规 打开「完整导航」）：
      ...
      >
        ...
        <div className="px-6 pt-6 pb-5">
          <div className="flex items-center justify-between mb-2">
            ...
            <button
              onClick={handleSkip}
              className="text-sm px-3 py-1.5 rounded-lg hover:bg-hover transition-colors text-txt-muted"
            >
              跳过
            </button>
          </div>
        ...
        {/* Content */}
        <div className="px-6 py-5 max-h-[44vh] overflow-y-auto border-y border-bdr/30 bg-elevated/40">
