              ...
              >
                <div
                  ...
                  style={{
                    ...
                    background: `linear-gradient(${preset.base["gradient-angle"]}deg, ${preset.base["gradient-from"]}, ${preset.base["gradient-to"]})`,
                    padding: 6,
                  }}
                >
                  <div
                  ...
                  >
                    <div
                      ...
                      style={{ width: 46, height: 12, backgroundColor: chat["msg-assistant"] }}
                    />
                    <div
                      className="rounded-full self-end"
                      style={{ width: 40, height: 12, backgroundColor: chat["msg-user"] }}
                    />
                  </div>
                </div>
